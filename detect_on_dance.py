# Make detection prediction on DanceTrack dataset
...
def main(args):
    ...
    # make save directory
    out_dir = f'{FILE.parents[0]}/results/detector/{trk_cfg.type_detector}/DanceTrack_{target_split}'
    ...
    for vid_idx, dance_dataset in enumerate(dance_videos):
        ...
        if save_pred:
            pred_save_path = os.path.join(save_dir, f'{vid_name}.txt')
...
def get_args():
    ...
    trk_cfg_file = 'conftrack_det'  # file name of target config in detector_cfgs directory
