...
def parse_args():
    ...
    pred_dirs = {
        'cplt': '/home/jhc/PycharmProjects/pythonProject/MOT_study/ConfTrack/results/tracker/ConfTrack_ablation_custom/DanceTrack_val/CPLT/DanceTrack-val/ConfTrack_ablation_custom/data',
    }
