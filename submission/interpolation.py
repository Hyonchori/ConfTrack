...
def get_mota(data_root, txt_path):
    accs = []
    seqs = sorted([s for s in os.listdir(data_root) if s.endswith('DPM') or s.endswith('FRCNN') or s.endswith('SDP')])
    #seqs = sorted([s for s in os.listdir(data_root)])
    for seq in seqs:
        video_out_path = os.path.join(txt_path, seq + '.txt')
        evaluator = Evaluator(data_root, seq, 'mot')
...
if __name__ == '__main__':
    # data_root = '/home/jhc/Desktop/dataset/open_dataset/MOT/MOT17/val'
    # txt_path = '/home/jhc/PycharmProjects/pythonProject/MOT_study/KLETrack_testbench_v2/results/tracker/KLETrack_v3_for_WACV2023/MOT17_test/submission_v3_noAM/MOT17-test/KLETrack_v3_for_WACV2023/data'
    # save_path = '/home/jhc/PycharmProjects/pythonProject/MOT_study/KLETrack_testbench_v2/results/tracker/KLETrack_v3_for_WACV2023/MOT17_test/submission_v3_noAM_interp/MOT17-test/KLETrack_v3_for_WACV2023/data'

    # data_root = '/home/jhc/Desktop/dataset/open_dataset/MOT/MOT17/val'
    # txt_path = '/home/jhc/PycharmProjects/pythonProject/MOT_study/ConfTrack/results/tracker/ConfTrack/MOT17_test/submission_v2/MOT17-test/ConfTrack/data'
    # save_path = '/home/jhc/PycharmProjects/pythonProject/MOT_study/ConfTrack/results/tracker/ConfTrack/MOT17_test/submission_v2_interp/MOT17-test/ConfTrack/data'

    data_root = '/home/jhc/Desktop/dataset/open_dataset/MOT/MOT20/val'
    txt_path = '/home/jhc/PycharmProjects/pythonProject/MOT_study/ConfTrack/results/tracker/ConfTrack/MOT20_test/submission_v2/MOT20-test/ConfTrack/data'
    save_path = '/home/jhc/PycharmProjects/pythonProject/MOT_study/ConfTrack/results/tracker/ConfTrack/MOT20_test/submission_v2_interp/MOT20-test/ConfTrack/data'
