...
def make_deepoc_args():
    ...
    # Attributes for general tracking
    ...
    parser.add_argument('--emb_off', action='store_true', default=False)
    parser.add_argument('--cmc_off', action='store_true', default=False)
    parser.add_argument('--aw_off', action='store_true', default=False)
    ...
    parser.add_argument('--extractor_weights', type=str, default='fast_reid_mot17')
    parser.add_argument('--half', action='store_true', default=True)

    # Attributes for CMC
    parser.add_argument('--type_cmc', type=str, default='file')
    parser.add_argument('--cmc_result_dir', type=str, default=f'{FILE.parents[2]}/cmc_files')
